 ...
 * @author Ghxstyzim
 */
public class FormTabFuncTemp extends javax.swing.JFrame {
    
    private BDFuncionario comandos = BDFuncionario.getInstanciaComandoHome();
    private static FormTabFuncTemp geraTabUnic;
   
    // Metodo Singleton 
    public static FormTabFuncTemp geraTabTemp(){
        if(geraTabUnic == null){
            geraTabUnic = new FormTabFuncTemp();
        }
        return geraTabUnic;
    }
    
    /**
     * Creates new form FormTabFuncTemp
     */
    public FormTabFuncTemp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Funcionarios Temporarios abaixo:");
        ...
        tableTemp.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "CPF", "Idade", "Salario", "Valor Hora", "Horas Trab."
            }
        ));
    ...
    public void excFuncionarioTemp() throws CpfInvalidoException {
    ...
    try {
        ...
        boolean removido = comandos.exFuncionarioCPF(temp);
        if (removido) {
    ...
    public void popularTbTemp(){

        DefaultTableModel modelo = (DefaultTableModel) tableTemp.getModel();
        modelo.setRowCount(0); 

        for (FuncionarioTemporario temp : comandos.getBdTemp()) {
            modelo.addRow(new Object[]{ temp.getNome(), temp.getCpf(), temp.getIdade(), temp.getSalario(),temp.getValorHora(), temp.gethorasTrabalhadas()});
        }
    }
