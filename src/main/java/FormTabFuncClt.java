 ...
 * @author Ghxstyzim
 */
public class FormTabFuncClt extends javax.swing.JFrame {

    private BDFuncionario comandos = BDFuncionario.getInstanciaComandoHome();
    private static FormTabFuncClt geraTabUnic;
   
    // Metodo Singleton
    public static FormTabFuncClt geraTabClt(){
        if(geraTabUnic == null){
            geraTabUnic = new FormTabFuncClt();
        }
        return geraTabUnic;
    }
    /**
     * Creates new form FormTabFuncClt
     */
    public FormTabFuncClt() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Funcionarios CLT abaixo:");
        ...
        jScrollPane1.setViewportView(tableClt);
    ...
    try {
        ...
        // Cria um objeto funcionário com o CPF informado (outros atributos podem ser ignorados)
        Funcionario funcionarioClt = new Funcionario();
        funcionarioClt.setCpf(cpf);
        
        boolean removido = comandos.exFuncionarioCPF(funcionarioClt);
        if (removido) {
    ...
    public void popularTbClt(){

        DefaultTableModel modelo = (DefaultTableModel) tableClt.getModel();
        modelo.setRowCount(0); 

    for (Funcionario clt : comandos.getBdClt()) {
        modelo.addRow(new Object[]{ clt.getNome(), clt.getCpf(), clt.getIdade(), clt.getSalario()});
    }
    }
